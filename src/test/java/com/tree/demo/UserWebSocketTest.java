...
import com.tree.api.client.TreeWebSocketClient;
import com.tree.api.dto.websocket.Method;
import com.tree.api.dto.websocket.RequestMessage;
import com.tree.api.dto.websocket.Topic;
...
public class UserWebSocketTest {
    Gson gson = new Gson();
    TreeWebSocketClient webSocketClient = null;
    @Before
    public void init(){
        try {
            webSocketClient = new TreeWebSocketClient("wss://fstream.treeexchange.io/ws/user");
